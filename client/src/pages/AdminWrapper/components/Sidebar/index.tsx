            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/admin/orders"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname === "/admin/orders" && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
                  ...
                  >
                    <path
                      d="M3 1C2.44772 1 2 1.44772 2 2V3H16V2C16 1.44772 15.5523 1 15 1H3ZM1 4V16C1 16.5523 1.44772 17 2 17H16C16.5523 17 17 16.5523 17 16V4H1ZM5 8H7V10H5V8ZM5 11H7V13H5V11ZM5 14H7V16H5V14ZM9 8H11V10H9V8ZM9 11H11V13H9V11ZM9 14H11V16H9V14ZM13 8H15V10H13V8ZM13 11H15V13H13V11ZM13 14H15V16H13V14Z"
                      fill=""
                    />
                  </svg>
                  Orders
              ...
              <li>
                <NavLink
                  to="/admin/products"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname === "/admin/products" && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
