...
const Footer = () => {
  return (
    <footer className="bg-white mt-auto">
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 pt-16 pb-6 sm:px-6 lg:space-y-16 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-4 max-w-xs text-gray-500">Awesome grocery store website template</p>

            <ul className="mt-8 flex gap-4">
              <li>
                <Link to="" rel="noreferrer" className="text-main transition hover:opacity-75">
        ...
        <p className="text-xs text-center text-gray-500">
          &copy; 2022. NestMart. All rights reserved.
        </p>
      </div>
    </footer>
  );
